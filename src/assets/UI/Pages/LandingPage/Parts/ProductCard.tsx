...
const ProductCard: React.FC<product> = ({ isproduct = false, product, relatedads }) => {
  const navigate = useNavigate();

  return (
    <Product onClick={() => { navigate("/product-details") }} product={product} relatedads={relatedads}>
